<%@ Page Title="Registrar Pagos" Language="C#" MasterPageFile="~/Modal.Master" AutoEventWireup="true" CodeBehind="RegistrarPagosFA.aspx.cs" Inherits="BrakGeWeb.RegistrarPagosFA" %>
              ...
              <div class="col-md-12 ">
				    ...
				    <!--Panel heading-->
				        <div class="panel-heading">
					        <h3 class="panel-title">Regsitrar Pago de Cuentas Pendientes</h3>  
				        </div>
                                                ...
                                                <div class="col-md-2 form-group" >
                                                   <label>Modo Pago</label>
                                                    <asp:DropDownList ID="ModoPago" runat="server" CssClass="form-control">
                                                        ...
                                                        <asp:ListItem>Pagos En Linea</asp:ListItem>
...
<%--    <script src="js/jquery-2.1.1.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function bPostaBack() {
            ...
            history.pushState(stateObj, "page 2", "RegistrarPagosFA.aspx");
