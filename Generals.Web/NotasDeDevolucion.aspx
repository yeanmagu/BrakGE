<%@ Page Title="Notas De Devolucion" Language="C#" MasterPageFile="~/Modal.Master" AutoEventWireup="true" CodeBehind="NotasDeDevolucion.aspx.cs" Inherits="BrakGeWeb.NotasDeDevolucion" %>  
              ...
              <div class="col-md-12 ">
				    ...
				    <!--Panel heading-->
				        <div class="panel-heading">
                            <h3 class="panel-title">Notas De Devolucion</h3> 
				        </div>
				        <!--Panel body-->
                                  ...
                                  <div class="row">
                                         <div class="col-md-12">
                                                        ...
                                                        <div class="row" >
                                                            <div class="col-md-12">
                                                                  ...
                                                                  <div class="panel formgrid" >   
                                                                       <div class="panel-heading">
				                                                        <h3 class="panel-title">Notas de Devoluciones
                                                ...
                                                <asp:Panel ID="pnlDatos" runat="server">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                             <asp:Button ID="btnGuardar" runat="server" Text="Crear Nota"  OnClientClick="return confirm('Esta seguro que desea Anular Esta Factura?');"  OnClick="BtnGuardar_Click" CssClass="btn btn-purple" />
...
<%--    <script src="js/jquery-2.1.1.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function bPostaBack() {
            ...
            history.pushState(stateObj, "page 2", "NotasDeDevolucion.aspx");
