<%@ Page Title="Generar Acuerdos de Facturas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GenerarPagoFacturasAntiguas.aspx.cs" Inherits="BrakGeWeb.GenerarPagoFacturasAntiguas" %>
                                                                ...
                                                                <div class="panel-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <asp:GridView ID="GridAcuerdos" runat="server" CssClass="table table-striped table-bordered dataTable no-footer dtr-inline" CellSpacing="0" role="grid" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="false" OnPageIndexChanging="GridAcuerdos_PageIndexChanging"
                                                                                EmptyDataText="NO EXISTEN ACUERDOS DE PAGO" EmptyDataRowStyle-BackColor="Gray" EmptyDataRowStyle-BorderColor="Gray" EmptyDataRowStyle-BorderStyle="Solid" EmptyDataRowStyle-ForeColor="White" EmptyDataRowStyle-HorizontalAlign="Center" EmptyDataRowStyle-VerticalAlign="Middle">
                                                                                <PagerSettings FirstPageText="Primero &nbsp;" LastPageText="Última &nbsp;" NextPageText="Siguiente &nbsp;" PreviousPageText="Anterior &nbsp;" Mode="NextPreviousFirstLast" />
                                                                                <AlternatingRowStyle BackColor="#F4F4F4" />
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:BoundField DataField="FechaCreacion" HeaderText="Fecha Acuerdo" SortExpression="FechaCreacion" />
                                                                                    <asp:BoundField DataField="NroCuotas" HeaderText="Nro. Cuotas" SortExpression="NroCuotas" />
                                                                                    <asp:BoundField DataField="FormaPago" HeaderText="Modo Pago" SortExpression="FormaPago" />
                                                                    ...
                                                                    <div class="panel panel-purple" >
                                                                     ...
                                                                     <div class="panel panel-purple" >    
                                                                      ...
                                                                      <div class="col-md-2">
                                                                                ...
                                                                                <div class="form-group col-md-2">
                                                                                     <label>Saldo Total</label>    
                                                                                       ...
                                                                                       <asp:TextBox  CssClass="form-control"  ID="SaldoTotal" runat="server" Text="0" ReadOnly="true" ></asp:TextBox>
                                                                                ...
                                                                                <div class=" form-group col-md-12">
                                                                                  <label>Descripción De La Factura</label>      <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server"  ErrorMessage="Descricpcion  Requerido" Text="*" 
                                                                                         ControlToValidate="Descricpcion" ForeColor="#ff0000" ValidationGroup="Grabar" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                                                     <asp:TextBox  CssClass="form-control" ID="Descricpcion" runat="server" ReadOnly="true" TextMode="MultiLine" ></asp:TextBox>
                                                                            </div>
                                                                      <div class="form-group col-md-2">
                                                                      ...
                                                                      <div class="form-group col-md-2">
                                                                                <label>Nro. Cuotas</label>  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="RequiredFieldValidator" Text="*" ForeColor="Red" ControlToValidate="Nrocuotas" SetFocusOnError="true" Display="Dynamic" ValidationGroup="Generar"></asp:RequiredFieldValidator>
                                                                       ...
                                                                       <div class="form-group col-md-2">
                                                                        ...
                                                                        <div class="form-group col-md-2">
                                                                            <br />
                                                                              <asp:Button ID="BtnGenerarPlan" runat="server" Text="Generar Plan " OnClick="BtnGenerarPlan_Click" ValidationGroup="Generar" CssClass="btn btn-purple" />
                                                                        </div>
                                                                     </div>
                                                                    </div>
                                                                    <div class="panel panel-purple" >
                                                                       ...
                                                                       <div class="row">
                                                                             <div class="col-md-12">
                                                                                   <asp:GridView ID="Detalle" runat="server" CssClass="table table-striped table-bordered dataTable no-footer dtr-inline" AllowPaging="True"   EmptyDataText="NO EXISTEN FACTURAS PENDIENTES" EmptyDataRowStyle-BackColor="Gray" EmptyDataRowStyle-BorderColor="Gray" EmptyDataRowStyle-BorderStyle="Solid" EmptyDataRowStyle-ForeColor="White" EmptyDataRowStyle-HorizontalAlign="Center" EmptyDataRowStyle-VerticalAlign="Middle"
                                                                                       AllowSorting="True" GridLines="None"   AutoGenerateColumns="False"   PageSize="20" OnPageIndexChanging="Detalle_PageIndexChanging">
                                                                                            <pagersettings firstpagetext="Primero &nbsp;" lastpagetext="Última &nbsp;" nextpagetext="Siguiente &nbsp;"  previouspagetext="Anterior &nbsp;" Mode="NextPreviousFirstLast" />
                                                                                                <AlternatingRowStyle BackColor="#F4F4F4" />
                                                                                                <Columns>
...
<%--    <script src="js/jquery-2.1.1.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function bPostaBack() {
            ...
            history.pushState(stateObj, "page 2", "GenerarPagoFacturasAntiguas.aspx");
