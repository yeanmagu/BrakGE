<%@ Page Title="Ingreso de Inventario" Language="C#" MasterPageFile="~/Modal.Master" AutoEventWireup="true" CodeBehind="IngresoDeInventario.aspx.cs" Inherits="BrakGeWeb.IngresoDeInventario" %>
                        ...
                        <div class="panel" >
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <br />
                                             <asp:Button ID="btnPopUp" runat="server" Text="Nuevo Cliente"  class="btn btn-info " OnClick="btnPopUp_Click"/>
                                                                                                ...
                                                                                                <Columns>
                                                                                                    ...
                                                                                                    <asp:TemplateField HeaderText="Actions">
                                                                                                        <ItemTemplate>
                                                                                                            ...
                                                                                                            <asp:ImageButton ID="DeleteItem" runat="server" CausesValidation="true" CommandArgument='<%# Eval("Id") %>'
...
<%--    <script src="js/jquery-2.1.1.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function bPostaBack() {
            ...
            history.pushState(stateObj, "page 2", "IngresoDeInventario.aspx");
