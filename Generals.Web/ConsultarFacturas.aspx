<%@ Page Title="Historial de Facturas" Language="C#" MasterPageFile="~/FrontCliente.Master" AutoEventWireup="true" CodeBehind="ConsultarFacturas.aspx.cs" Inherits="BrakGeWeb.ConsultarFacturas" %>  
                                                            ...
                                                            <div class="col-md-12">                              
                                                                  <div class="panel panel-purple" >   
                                                                       <div class="panel-heading">
				                                                            <h3 class="panel-title">Historial de Facturas    
				                                                            </h3>         
				                                                        </div>                       
                                                                                            ...
                                                                                            <pagersettings firstpagetext="Primero &nbsp;" lastpagetext="Última &nbsp;" nextpagetext="Siguiente &nbsp;"  previouspagetext="Anterior &nbsp;" Mode="NextPreviousFirstLast"  />
                                                                                                ...
                                                                                                <Columns>                                       
                                                                                                    ...
                                                                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Actions">
                                                                                                        <ItemTemplate>         
                                                                                                            <asp:ImageButton ID="Editar"  ToolTip="Facturar"      ImageUrl="~/images/Selecet.png" CssClass="celdasMedidor" Width="20px" Height="20px"  ImageAlign="Middle"
...
<%--    <script src="js/jquery-2.1.1.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function bPostaBack() {
            ...
            history.pushState(stateObj, "page 2", "ConsultarFacturas.aspx");
