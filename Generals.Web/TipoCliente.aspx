<%@ Page Title="Tipo Cliente" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TipoCliente.aspx.cs" Inherits="BrakGeWeb.TipoCliente" %>
              ...
              <div class="col-md-12 ">
				    ...
				    <!--Panel heading-->
				        <div class="panel-heading">
                            <asp:Label ID="Tittle" runat="server" clasa="form-control" Text="Tipo de Clientes" Font-Size="Large" BorderColor="#3366FF"></asp:Label>                                       
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="searchbox">
                                                                                  ...
                                                                                  <%--  <div class="dataTables_filter" id="demo-dt-basic_filter"><label>Buscar:<asp:TextBox  CssClass="form-control input-sm" ID="TxtBusqueda" runat="server" OnTextChanged="TxtBusqueda_TextChanged" AutoPostBack="True"  ></asp:TextBox>  </div>  --%>                    
                                                                                    <asp:GridView ID="GridTipoCliente" runat="server" CssClass="table table-striped table-bordered dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid"  style="width: 100%;" PageSize="10" AllowPaging="True" AllowSorting="True" OnPageIndexChanging="GridTipoCliente_PageIndexChanging" GridLines="None" AutoGenerateColumns="false" >
...
<%--    <script src="js/jquery-2.1.1.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function bPostaBack() {
            ...
            history.pushState(stateObj, "page 2", "TipoCliente.aspx");
