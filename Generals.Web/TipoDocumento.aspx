<%@ Page Title="Tipo Documento" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TipoDocumento.aspx.cs" Inherits="BrakGeWeb.TipoDocumento" %>
              ...
              <div class="col-md-12 ">
				    ...
				    <!--Panel heading-->
				        <div class="panel-heading">
                            <asp:Label ID="Tittle" runat="server" clasa="form-control" Text="Tipo De Documento" Font-Size="Large" BorderColor="#3366FF"></asp:Label>                                       
                                                                  ...
                                                                  <div class="panel-body">                  
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                    ...
                                                                                    <asp:GridView ID="GridTipoDocumento" runat="server"  AutoGenerateColumns="False" Width="100%" PageSize="5" AllowPaging="True" AllowSorting="True" OnPageIndexChanging="GridTipoDocumento_PageIndexChanging" GridLines="None" >
...
<%--    <script src="js/jquery-2.1.1.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function bPostaBack() {
            ...
            history.pushState(stateObj, "page 2", "TipoDocumento.aspx");
