<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImprimirAcuerdo.aspx.cs" Inherits="BrakGeWeb.ImprimirAcuerdo" %>
...
<body>
    ...
    <div>
             <rsweb:ReportViewer ID="ReportViewer2" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="800px" Width="100%">
                             <localreport reportpath="Reportes\Acuerdo.rdlc" ReportEmbeddedResource="" >
                                 <datasources>
                         ...
                         <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="BrakGeWeb.Datasets.facturaTableAdapters.DatosEmpresaTableAdapter">
                          ...
                          <asp:ObjectDataSource ID="ObjectDataSource4" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="BrakGeWeb.Datasets.AcuerdoPagoTableAdapters.Sp_AcuerdoPagoTableAdapter">
                             
                              <SelectParameters>
                                  <asp:QueryStringParameter QueryStringField="NA" Name="NroAcuerdo" Type="Int32"></asp:QueryStringParameter>
