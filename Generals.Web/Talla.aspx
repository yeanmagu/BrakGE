<%@ Page Title="Talla" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Talla.aspx.cs" Inherits="BrakGeWeb.Talla" %>
              ...
              <div class="col-md-12 ">
				    ...
				    <!--Panel heading-->
				        <div class="panel-heading">
                            <asp:Label ID="Tittle" runat="server" clasa="form-control" Text="Talla" Font-Size="Large" BorderColor="#3366FF"></asp:Label>                                       
                                                                      ...
                                                                      <div class="panel-body">                  
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    ...
                                                                                    <br />               
                                                                                        <asp:GridView ID="GridTalla" runat="server" CssClass="table table-striped table-bordered dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid"  style="width: 100%;" PageSize="10" AllowPaging="True" AllowSorting="True" OnPageIndexChanging="GridTalla_PageIndexChanging" GridLines="None" AutoGenerateColumns="false" >
                                                                                            <pagersettings firstpagetext="Primero &nbsp;" lastpagetext="Última &nbsp;" nextpagetext="Siguiente &nbsp;"  previouspagetext="Anterior &nbsp;" Mode="NextPreviousFirstLast" />
                                                                                                ...
                                                                                                <Columns>                                       
                                                                                                    ...
                                                                                                    <asp:BoundField DataField="CodigoTalla" HeaderText="Codigo" 
                                                                                                        SortExpression="CodigoTalla" />
                                                                    ...
                                                                    <div class="panel-body">
                                                                        <div class="row">
                                                                            <div class="form-group col-md-4">
                                                                                <label>Codigo Talla:</label>
                                                                                <asp:TextBox  CssClass="form-control" ID="CodigoTalla" runat="server" MaxLength="150" ></asp:TextBox>
                                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*"
                                                                                                    ControlToValidate="CodigoTalla" ForeColor="#ff0000" ValidationGroup="Grabar" SetFocusOnError="true"></asp:RequiredFieldValidator> 
                                                                            </div> 
...
<%--    <script src="js/jquery-2.1.1.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function bPostaBack() {
            ...
            history.pushState(stateObj, "page 2", "Talla.aspx");
