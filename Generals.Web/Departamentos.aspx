<%@ Page Title="Departamentos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Departamentos.aspx.cs" Inherits="BrakGeWeb.Dpto" %>
...
<%--                                    <h4>                        --%>
                                        ...
                                        <asp:Label ID="Tittle" runat="server" Text="Administrar Departamentos" Font-Size="Large" BorderColor="#3366FF"></asp:Label>                                       
                                  <%--  </h4>--%>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="searchbox">
                                                                                        ...
                                                                                        <asp:GridView ID="GridDpto" runat="server" CssClass="table table-striped table-bordered "  role="grid"   PageSize="10" AllowPaging="True" AllowSorting="True" OnPageIndexChanging="GridDpto_PageIndexChanging" GridLines="None" AutoGenerateColumns="false" >
...
<%--    <script src="js/jquery-2.1.1.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function bPostaBack() {
            ...
            history.pushState(stateObj, "page 2", "Departamentos.aspx");
