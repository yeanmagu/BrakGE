<%@ Page Title="COTIZACION" Language="C#" MasterPageFile="~/Modal.Master" AutoEventWireup="true" CodeBehind="Cotizacion.aspx.cs" Inherits="BrakGeWeb.Cotizacion" %>  
                                                                                            ...
                                                                                            <pagersettings firstpagetext="Primero &nbsp;" lastpagetext="Última &nbsp;" nextpagetext="Siguiente &nbsp;"  previouspagetext="Anterior &nbsp;" Mode="NextPreviousFirstLast"  />
                                                                                                ...
                                                                                                <Columns>                                       
                                                                                                    ...
                                                                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Actions">
                                                                                                        <ItemTemplate>         
                                                                                                            <asp:ImageButton ID="Editar"  ToolTip="Facturar"      ImageUrl="~/images/Selecet.png" CssClass="celdasMedidor"  ImageAlign="Middle"
                                                                                                          ...
                                                                                                          <%-- <asp:ImageButton ID="BtnAnular" runat="server"   ImageUrl="~/images/delete.png" CssClass="celdasMedidor"  ImageAlign="Middle" CausesValidation="true" CommandArgument='<%# Eval("Id") %>' 
                                                                                                             ...
                                                                                                             <%-- <asp:ImageButton ID="Ot"  ToolTip="Generar Orden de Trabajo"      ImageUrl="~/images/Ot.png" CssClass="celdasMedidor"  ImageAlign="Middle"
                                                                                                              runat="server"  CommandArgument='<%# Eval("Id") %>' CommandName="OrdenDeTrabajo"  OnCommand="Ot_Command" />  --%>
                                                                                                        </ItemTemplate>
                                                        ...
                                                        <div class="col-md-12">
                                                          ...
                                                          <%--  <button runat="server" id="Guardar"  onserverclick="BtnGuardar_Click"  class="btn btn-purple" ><span class="icon"><i class="fa fa-plus"></i></span>&nbsp; Guardar
                                                            ...
                                                            <button runat="server" id="Cancelar"  onserverclick="Cancelar_Click"  class="btn btn-purple"><span class="icon"><i class="fa fa-rotate-right"></i></span>&nbsp;Cancelar
                                                             ...
                                                             <asp:Button ID="btnGuardar" runat="server" Text="Cotizar" OnClick="BtnGuardar_Click" CssClass="btn btn-purple" />
                                                            <asp:Button ID="BtnAprobar" runat="server" Text="Facturar" OnClick="BtnAprobar_Click" Visible="false" CssClass="btn btn-purple" />
                                                             <asp:Button ID="BtnOt" runat="server" Text="Orden de Trabajo" OnClick="BtnOt_Click" CssClass="btn btn-purple" Visible="false" />
...
<%--    <script src="js/jquery-2.1.1.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function bPostaBack() {
            ...
            history.pushState(stateObj, "page 2", "Cotizacion.aspx");
