<%@ Page Title="Tipo Acta" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TipoActa.aspx.cs" Inherits="BrakGeWeb.TipoActa" %>
              ...
              <div class="col-md-12 ">
				    ...
				    <!--Panel heading-->
				        <div class="panel-heading">
                            <asp:Label ID="Tittle" runat="server" clasa="form-control" Text="Tipo de Actas" Font-Size="Large" BorderColor="#3366FF"></asp:Label>                                       
                                                                  ...
                                                                  <div class="panel-body">                  
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                    ...
                                                                                    <asp:GridView ID="GridTipoActa" runat="server" CssClass="table table-striped" AutoGenerateColumns="False" Width="100%" PageSize="5" AllowPaging="True" AllowSorting="True" OnPageIndexChanging="GridTipoActa_PageIndexChanging" GridLines="None" >
