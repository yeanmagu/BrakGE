<%@ Page Title="Inventario" Language="C#" MasterPageFile="~/Modal.Master" AutoEventWireup="true" CodeBehind="Inventario.aspx.cs" Inherits="BrakGeWeb.Inventario" %>
...
<%--                                    <h4>                        --%>
                                      ...
                                      <h3 class="panel-title">Gestion de Inventario</h3>  
                                  <%--  </h4>--%>
...
<%--    <script src="js/jquery-2.1.1.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function bPostaBack() {
            ...
            history.pushState(stateObj, "page 2", "Inventario.aspx");
