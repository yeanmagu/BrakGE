<%@ Page Title="Consultar Facturas Pendientes" Language="C#" MasterPageFile="~/FrontCliente.Master" AutoEventWireup="true" CodeBehind="ConsultarFacturasPendientes.aspx.cs" Inherits="BrakGeWeb.ConsultarFacturasPendientes" %>  
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-12 ">
                                                                                        ...
                                                                                        <asp:GridView ID="GridDocumentos" runat="server" CssClass="table table-striped table-bordered dataTable no-footer dtr-inline" cellspacing="0"  role="grid"  PageSize="10" AllowPaging="True" OnDataBound="GridDocumentos_DataBound" OnRowDataBound="GridDocumentos_RowDataBound" AllowSorting="True" AutoGenerateColumns="false"  OnPageIndexChanging="GridDocumentos_PageIndexChanging"
                                                                                              EmptyDataText="NO EXISTEN FACTURAS EN ESTE HISTORIAL" EmptyDataRowStyle-BackColor="Gray" EmptyDataRowStyle-BorderColor="#cfcfc9" EmptyDataRowStyle-BorderStyle="Solid" EmptyDataRowStyle-ForeColor="White" EmptyDataRowStyle-HorizontalAlign="Center" EmptyDataRowStyle-VerticalAlign="Middle">
                                                                                            <pagersettings firstpagetext="Primero &nbsp;" lastpagetext="Última &nbsp;" nextpagetext="Siguiente &nbsp;"  previouspagetext="Anterior &nbsp;" Mode="NextPreviousFirstLast"  />
                                                                                                ...
                                                                                                <Columns>                                       
                                                                                                    ...
                                                                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Actions">
                                                                                                        <ItemTemplate>         
                                                                                                            <asp:ImageButton ID="Editar"  ToolTip="Facturar"      ImageUrl="~/images/Selecet.png" Width="20px" Height="20px" CssClass="celdasMedidor"  ImageAlign="Middle"
                                                                        ...
                                                                        <div class="row">
                                                                             <div class="col-md-12">
                                                                                   <asp:GridView ID="Detalle" runat="server" CssClass="table table-striped table-bordered dataTable no-footer dtr-inline" AllowPaging="True"   
                                                                                       AllowSorting="True" GridLines="None" AutoGenerateColumns="False"  OnRowDataBound="Detalle_RowDataBound" >
                                                                                            <pagersettings firstpagetext="Primero &nbsp;" lastpagetext="Última &nbsp;" nextpagetext="Siguiente &nbsp;"  previouspagetext="Anterior &nbsp;" Mode="NextPreviousFirstLast" />
                                                                                                <AlternatingRowStyle BackColor="#F4F4F4" />
                                                                                                <Columns>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="form-group col-md-2">
                                                                             ...
                                                                             <div class="col-md-4">
                                                                                ...
                                                                                <asp:DropDownList ID="Vendedor" runat="server" CssClass="form-control"  Enabled="false" ></asp:DropDownList>  
                                                                             </div>
                                                                        </div>
                                                                       <div class="row" style="display:none;">
                                                                               <div class="form-group col-md-12">
                                                                                <label>Motivo de Devolución</label>
                                                                                <asp:TextBox ID="Motivo" CssClass="form-control" runat="server" ReadOnly="true" TextMode="MultiLine"></asp:TextBox>
...
<%--    <script src="js/jquery-2.1.1.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function bPostaBack() {
            ...
            history.pushState(stateObj, "page 2", "ConsultarFacturasPendientes.aspx");
