<%@ Page Title="ORDENES DE COMPRA" Language="C#" MasterPageFile="~/Modal.Master" AutoEventWireup="true" CodeBehind="Pedidos.aspx.cs" Inherits="BrakGeWeb.Pedidos" %>   
...
<script src="Scripts/EventForms.js"></script>
    ...
    <style type="text/css">
        .panel {
            /*box-shadow: 1px 1px 1px 1px #3b4498;*/
                                                                                            ...
                                                                                            <pagersettings firstpagetext="Primero &nbsp;" lastpagetext="Última &nbsp;" nextpagetext="Siguiente &nbsp;"  previouspagetext="Anterior &nbsp;" Mode="NextPreviousFirstLast"  />
                                                                                                ...
                                                                                                <Columns>                                       
                                                                                                    ...
                                                                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Actions">
                                                                                                        <ItemTemplate>         
                                                                                                            <asp:ImageButton ID="Editar"  ToolTip=" Aprobar"      ImageUrl="~/images/Selecet.png" CssClass="celdasMedidor"  ImageAlign="Middle"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="form-group col-md-2">
                                                                                ...
                                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"  ErrorMessage="Fecha  Requerido" Text="*" 
                                                                                   ...
                                                                                   <asp:TextBox  CssClass="form-control"  ID="Fecha" runat="server"  ReadOnly="true" Enabled="false" ></asp:TextBox>
                                                                            </div>
                                                                            <div class="col-md-2">
                                                                                <br />
                                                                                            ...
                                                                                            <pagersettings firstpagetext="Primero &nbsp;" lastpagetext="Última &nbsp;" nextpagetext="Siguiente &nbsp;"  previouspagetext="Anterior &nbsp;" Mode="NextPreviousFirstLast" />
                                                                                                ...
                                                                                                <Columns>
                                                                                                    ...
                                                                                                    <asp:TemplateField HeaderText="Producto" Visible ="true" SortExpression="Producto">
                                                                                                     ...
                                                                                                     <asp:TemplateField HeaderText="Precio Compra" Visible ="true" SortExpression="Preci o">
                                                                                                        <ItemTemplate>
                                                                                                            <asp:Label ID="lbl_PrecioCompra" runat="server" Text='<%# (String.Format("{0:C}", Eval("PrecioCompra"))) %>' ></asp:Label>
                                                                                                          </ItemTemplate>
                                                                                                        <EditItemTemplate>
                                                                                                            <asp:TextBox runat="server" Text='<%# Bind("PrecioCompra") %>'  ID="TxtPrecioCompra" CssClass="form-control"> </asp:TextBox>
                                                                                                        </EditItemTemplate>
                                                                                                    ...
                                                                                                    <asp:TemplateField HeaderText="Precio Venta" Visible ="true" SortExpression="Precio">
                                                                                                        ...
                                                                                                        <EditItemTemplate>
                                                                                                            <asp:TextBox runat="server" Text='<%# Bind("Precio") %>'  ID="TxtPrecio" CssClass="form-control"> </asp:TextBox>
                                                                                                        </EditItemTemplate>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                          ...
                                                          <%--  <button runat="server" id="Guardar"  onserverclick="BtnGuardar_Click"  class="btn btn-purple" ><span class="icon"><i class="fa fa-plus"></i></span>&nbsp; Guardar
                                                            ...
                                                            <asp:Button ID="BtnAprobar" runat="server" Text="Aprobar" OnClick="BtnAprobar_Click" CssClass="btn btn-purple" />
...
<%--    <script src="js/jquery-2.1.1.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function bPostaBack() {
            ...
            history.pushState(stateObj, "page 2", "Pedidos.aspx");
