<%@ Page Title="Materiales" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Materiales.aspx.cs" Inherits="BrakGeWeb.Materiales" %>
              ...
              <div class="col-md-12 ">
				    ...
				    <!--Panel heading-->
				        <div class="panel-heading">
                                        ...
                                        <asp:Label ID="Tittle" runat="server" clasa="form-control" Text="Materiales" Font-Size="Large" BorderColor="#3366FF"></asp:Label>                                       
                                                                  ...
                                                                  <div class="panel-body">                  
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                    ...
                                                                                    <asp:GridView ID="GridMateriales" runat="server" CssClass="table table-striped" AutoGenerateColumns="False" Width="100%" PageSize="5" AllowPaging="True" AllowSorting="True" OnPageIndexChanging="GridMateriales_PageIndexChanging" GridLines="None" >
