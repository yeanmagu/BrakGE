<%@ Page Title="Administración de TipoMovimientos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TipoMovimiento.aspx.cs" Inherits="BrakGeWeb.TipoMovimiento" %>
              ...
              <div class="col-md-12 ">
				    ...
				    <!--Panel heading-->
				        <div class="panel-heading">
                            <h3 class="panel-title">Tipo de Movimiento</h3>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-12">
                                                                                        <div class="searchbox">
                                                                                            ...
                                                                                            <asp:GridView ID="GridTipoMovimiento" runat="server" CssClass="table table-striped table-bordered dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid"  style="width: 100%;" PageSize="10" AllowPaging="True" AllowSorting="True" OnPageIndexChanging="GridTipoMovimiento_PageIndexChanging" GridLines="None" AutoGenerateColumns="false"  >
                                                                ...
                                                                <div class="panel formdata" >
                                                                        ...
                                                                        <div class="panel-body">
                                                                                <div class="row">
                                                                                        ...
                                                                                        <div class="form-group col-md-2">
                                                                                            <label>Sw</label>
                                                                                             <asp:DropDownList ID="CmbSw"  CssClass="form-control" runat="server"></asp:DropDownList>
                                                                                        </div>
                                                                                        <div class="form-group col-md-2">
                                                                                            <br />
                                                                                            <asp:CheckBox ID="ExcentoDeIva" runat="server"  Text="Excento de Iva"/>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="row">
                                                                                       <div class="form-group col-md-12">
                                                                                             <label>Notas</label>
                                                                                             <asp:TextBox ID="Notas"  CssClass="form-control" TextMode="MultiLine" runat="server"></asp:TextBox>
                                                                                         </div>
                                                                                   </div>
                                                                                     <div class="row">
...
<%--    <script src="js/jquery-2.1.1.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function bPostaBack() {
            ...
            history.pushState(stateObj, "page 2", "TipoMovimiento.aspx");
