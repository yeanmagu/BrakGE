<%@ Page Title="Municipios" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Municipios.aspx.cs" Inherits="BrakGeWeb.Municipios" %>
                                            ...
                                            <div class="col-md-12">
                                                <div class="searchbox">
                                                  ...
                                                  <%--  <div class="dataTables_filter" id="demo-dt-basic_filter"><label>Buscar:<asp:TextBox  CssClass="form-control input-sm" ID="TxtBusqueda" runat="server" OnTextChanged="TxtBusqueda_TextChanged" AutoPostBack="True"  ></asp:TextBox>  </div>  --%>                    
                                                    <asp:GridView ID="GridMunicipio" runat="server" CssClass="table table-striped table-bordered dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid"  style="width: 100%;" PageSize="10" AllowPaging="True" AllowSorting="True" 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                         ...
                                         <div class="form-group col-md-4">
                                           ...
                                           <asp:DropDownList ID="Departamento" runat="server" CssClass="form-control"></asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*"
                                                 ControlToValidate="Departamento" ForeColor="#ff0000" ValidationGroup="Grabar" SetFocusOnError="true" InitialValue="0"></asp:RequiredFieldValidator>
...
<%--    <script src="js/jquery-2.1.1.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function bPostaBack() {
            ...
            history.pushState(stateObj, "page 2", "Municipios.aspx");
